...
class spi_arduino_master(rtl,eldo,thesdk):
    @property
    def _classfile(self):
    ...
    def run(self,*arg):
        ...
        if self.model=='py':
          ...
          if self.model=='vhdl':
              ...
              # Example of defining supplies (not used here because the example spi_arduino_master has no supplies)
...
if __name__=="__main__":
    ...
    controller=spi_arduino_master_controller()
    controller.Rs=rs
    #controller.reset()
